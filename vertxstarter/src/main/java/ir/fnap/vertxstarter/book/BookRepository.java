package ir.fnap.vertxstarter.book;
...
public class BookRepository {
  ...
  public BookRepository(final Vertx vertx) {
    ...
    config.put("url", "jdbc:postgresql://127.0.0.1/book");
    config.put("driver_class", "org.postgresql.Driver");
    config.put("user", "postgres");
    config.put("password", "parsa"); //For production manage password in config file or through env
